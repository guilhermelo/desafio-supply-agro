...
class ValidacaoPlantioTest {
    ...
    void deveLancarExcecaoTalhaoJaEncerrado() {
        ...
        assertThrows(OperacaoInvalidaException.class, () ->
                new ValidacaoPlantio().valida(talhao, colheita.gerarEvento()), "Talhão já encerrado!");
    }
    ...
    void deveLancarExcecaoAreaColheitaMaiorAreaTalhao() {
        ...
        assertThrows(OperacaoInvalidaException.class,
                () -> new ValidacaoPlantio().valida(talhao, colheita.gerarEvento()),
    ...
    void deveLancarExcecaoQuandoSomaAreaEventosDoMesmoTipoMaiorAreaTalhao() {
        ...
        assertThrows(OperacaoInvalidaException.class,
                () -> new ValidacaoPlantio().valida(talhao, colheitaDois.gerarEvento()),
