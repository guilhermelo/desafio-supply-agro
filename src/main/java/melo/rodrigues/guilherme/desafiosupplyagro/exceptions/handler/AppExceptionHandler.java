...
public class AppExceptionHandler {
    ...
    public ApiErrorResponse handleValidations(MethodArgumentNotValidException e) {
        ...
        return new ApiErrorResponse("ValidationError", mensagem, mensagemDetalhe, "", Collections.unmodifiableList(detalhes));
    }
}
